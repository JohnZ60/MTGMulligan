...
def get_RDW_deck():
    ...
    self.cards.append(cards.Land('Castle Embereth', 'Land', '', [lambda self: self.owner.add_mana({"Red": 1}), "Castle Embereth enters the battlefield tapped unless you control a Mountain.Tap: Add R,  1RRTAP: Creatures you control get +1/+0 until end of turn."]))
    for i in range(1,16):
        cards.Land("Mountain", "Basic Land", "Mountain", [lambda self: self.owner.add_mana({"Red": 1})])
