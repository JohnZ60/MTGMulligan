...
def get_RDW_deck():
    ...
    self.cards.append(cards.Creature('Fervent Champion', "Human Knight", {'Red': 1, 'Generic': 0}, 1, 1, 'First strike, haste \nWhenever Fervent Champion attacks, another target attacking Knight you control gets +1/+0 until end of turn. \nEquip abilities you activate that target Fervent Champion cost 3 less to activate.\n'))
        ...
        for i in ['Hearts', 'Clubs', 'Diamonds']: #count to 3
            ...
            self.cards.append(cards.Creature('Torbran, Thane of Red Fell', 'Dwarf Noble',{'Red': 3, 'Generic': 1}, 2, 4, "If a red source you control would deal damage to an opponent or a permanent an opponent controls, it deals that much damage plus 2 instead."))
            self.cards.append(cards.Artifact('Embercleave', 'Equipment' ,{'Red': 1, 'Generic': 0}, "Flash\nThis spell costs 1 less to cast for each attacking creature you control.\nWhen Embercleave enters the battlefield, attach it to target creature you control.\nEquipped creature gets +1/+1 and has double strike and trample.\nEquip 3 "))
            self.cards.append(cards.Sorcery('Claim the Firstborn', '', {'Red': 1, 'Generic': 0}, "Gain control of target creature with converted mana cost 3 or less until end of turn. Untap that creature. It gains haste until end of turn."))
            self.cards.append(cards.Land('Castle Embereth', 1, '', [lambda self: self.owner.add_mana({"Red": 1}), "Castle Embereth enters the battlefield tapped unless you control a Mountain.Tap: Add R,  1RRTAP: Creatures you control get +1/+0 until end of turn."]))
            cards.Land("Mountain", "Basic Land", "Mountain", [lambda self: self.owner.add_mana({"Red": 1})]))