...
def get_RDW_deck():
    decklist = []
    self.cards.append(cards.Creature('Fervent Champion', "Human Knight", {'Red': 1, 'Generic': 0}, 1, 1, 'First strike, haste \nWhenever Fervent Champion attacks, another target attacking Knight you control gets +1/+0 until end of turn. \nEquip abilities you activate that target Fervent Champion cost 3 less to activate.\n'))
        self.cards.append(cards.Creature('Scorch Spitter', 'Elemental Lizard', {'Red': 1, 'Generic': 0}, 1, 1, 'Whenever Scorch Spitter attacks, it deals 1 damage to the player or planeswalker it\'s attacking.'))
        self.cards.append(cards.Creature('Robber of the Rich', 'Human Archer Rogue', {'Red': 1, 'Generic': 1}, 2, 2, 'Reach, haste\nWhenever Robber of the Rich attacks, if defending player has more cards in hand than you, exile the top card of their library. \nDuring any turn you attacked with a Rogue, you may cast that card and you may spend mana as though it were mana of any color to cast that spell.'))
        self.cards.append(cards.Creature('Runaway Steam-Kin', 'Elemental',{'Red': 1, 'Generic': 1}, 1, 1, "Whenever you cast a red spell, if Runaway Steam-Kin has fewer than three +1/+1 counters on it, put a +1/+1 counter on Runaway Steam-Kin.\nRemove three +1/+1 counters from Runaway Steam-Kin: Add ."))
        self.cards.append(cards.Creature('Anax, Hardened in the Forge', 'Demigod', {'Red': 2, 'Generic': 1}, 0, 3, "Legendary\n Enchantment\n Anax's power is equal to your devotion to red. (Each Red in the mana costs of permanents you control counts toward your devotion to red.)Whenever Anax or another nontoken creature you control dies, create a 1/1 red Satyr creature token with 'This creature can't block.' If the creature had power 4 or greater, create two of those tokens instead."))
        self.cards.append(cards.Creature('Bonecrusher Giant', 'Giant',{'Red': 1, 'Generic': 2}, 4, 3, "Stomp 1R: Instant - Adventure: Damage can't be prevented this turn. Stomp deals 2 damage to any target/Whenever Bonecrusher Giant becomes the target of a spell, Bonecrusher Giant deals 2 damage to that spell's controller."))
        self.cards.append(cards.Creature('Torbran, Thane of Red Fell', 'Dwarf Noble',{'Red': 3, 'Generic': 1}, 2, 4, "If a red source you control would deal damage to an opponent or a permanent an opponent controls, it deals that much damage plus 2 instead."))
        self.cards.append(cards.Artifact.Equipment('Embercleave', 'Equipment' ,{'Red': 1, 'Generic': 0}, "Flash\nThis spell costs 1 less to cast for each attacking creature you control.\nWhen Embercleave enters the battlefield, attach it to target creature you control.\nEquipped creature gets +1/+1 and has double strike and trample.\nEquip 3 "))
        self.cards.append(cards.Land('Castle Embereth', 'Land', '', [lambda self: self.owner.add_mana({"Red": 1})"Castle Embereth enters the battlefield tapped unless you control a Mountain.Tap: Add R,  1RRTAP: Creatures you control get +1/+0 until end of turn."], True))
        for i in range(1,16):
            cards.Land("Mountain", "Basic Land", "Mountain", [lambda self: self.owner.add_mana({"Red": 1})]))
        for i in ['Hearts', 'Clubs', 'Diamonds']: #count to 3
            self.cards.append(cards.Creature('Fervent Champion', "Human Knight", {'Red': 1, 'Generic': 0}, 1, 1, 'First strike, haste \nWhenever Fervent Champion attacks, another target attacking Knight you control gets +1/+0 until end of turn. \nEquip abilities you activate that target Fervent Champion cost 3 less to activate.\n'))
            self.cards.append(cards.Creature('Scorch Spitter', 'Elemental Lizard', {'Red': 1, 'Generic': 0}, 1, 1, 'Whenever Scorch Spitter attacks, it deals 1 damage to the player or planeswalker it\'s attacking.'))
            self.cards.append(cards.Creature('Rimrock Knight', 'Dwarf Knight', {'Red': 1, 'Generic': 1}, 3, 1, 'Adventure - Instant R : Target Creature gets +2/+0 until end of turn,\n Rimrock Knight can\'t block.', True))
            self.cards.append(cards.Creature('Robber of the Rich', 'Human Archer Rogue', {'Red': 1, 'Generic': 1}, 2, 2, 'Reach, haste\nWhenever Robber of the Rich attacks, if defending player has more cards in hand than you, exile the top card of their library. \nDuring any turn you attacked with a Rogue, you may cast that card and you may spend mana as though it were mana of any color to cast that spell.'))
            self.cards.append(cards.Creature('Runaway Steam-Kin', 'Elemental',{'Red': 1, 'Generic': 1}, 1, 1, "Whenever you cast a red spell, if Runaway Steam-Kin has fewer than three +1/+1 counters on it, put a +1/+1 counter on Runaway Steam-Kin.\nRemove three +1/+1 counters from Runaway Steam-Kin: Add ."))
            self.cards.append(cards.Creature('Anax, Hardened in the Forge', 'Demigod', {'Red': 2, 'Generic': 1}, 0, 3, "Legendary\n Enchantment\n Anax's power is equal to your devotion to red. (Each Red in the mana costs of permanents you control counts toward your devotion to red.)Whenever Anax or another nontoken creature you control dies, create a 1/1 red Satyr creature token with 'This creature can't block.' If the creature had power 4 or greater, create two of those tokens instead."))
            self.cards.append(cards.Creature('Bonecrusher Giant', 'Giant',{'Red': 1, 'Generic': 2}, 4, 3, "Stomp 1R: Instant - Adventure: Damage can't be prevented this turn. Stomp deals 2 damage to any target/Whenever Bonecrusher Giant becomes the target of a spell, Bonecrusher Giant deals 2 damage to that spell's controller."))
            self.cards.append(cards.Creature('Torbran, Thane of Red Fell', 'Dwarf Noble',{'Red': 3, 'Generic': 1}, 2, 4, "If a red source you control would deal damage to an opponent or a permanent an opponent controls, it deals that much damage plus 2 instead."))
            self.cards.append(cards.Artifact.Equipment('Embercleave', 'Equipment' ,{'Red': 1, 'Generic': 0}, "Flash\nThis spell costs 1 less to cast for each attacking creature you control.\nWhen Embercleave enters the battlefield, attach it to target creature you control.\nEquipped creature gets +1/+1 and has double strike and trample.\nEquip 3 "))
            self.cards.append(cards.Sorcery('Claim the Firstborn', 1, 1, 'R', 2, 2, "Gain control of target creature with converted mana cost 3 or less until end of turn. Untap that creature. It gains haste until end of turn.", False))
            self.cards.append(cards.Artifact('Embercleave', 6, 6, '4RR', 0, 0, "Flash\nThis spell costs 1 less to cast for each attacking creature you control.\nWhen Embercleave enters the battlefield, attach it to target creature you control.\nEquipped creature gets +1/+1 and has double strike and trample.\nEquip 3 ", False))
            self.cards.append(cards.Land('Castle Embereth', 1, 'R', "Castle Embereth enters the battlefield tapped unless you control a Mountain.Tap: Add R,  1RRTAP: Creatures you control get +1/+0 until end of turn.", True))
            cards.Land("Mountain", "Basic Land", "Mountain", [lambda self: self.owner.add_mana({"Red": 1})]))